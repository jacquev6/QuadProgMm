...
nitpick_ignore = [
    ...
    ("cpp:identifier", "boost::dividable<LinearExpression, double>"),
    ("cpp:identifier", "boost::dividable<QuadraticExpression, double>"),
    ("cpp:identifier", "boost::multipliable<LinearExpression, double>"),
    ("cpp:identifier", "boost::multipliable<QuadraticExpression, double>"),
    ("cpp:identifier", "boost::subtractable<LinearExpression>"),
    ("cpp:identifier", "boost::subtractable<QuadraticExpression>"),
